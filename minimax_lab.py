...
class Laberinto:
    ...
    def actualizar_tablero(self):
        ...
        self.tablero = [['-' for _ in range(self.dimensiones)] for _ in range(self.dimensiones)]  # la _ es para no usar una variable innecesaria
                                                         #  conocido como "anidamiento"
    ...
    def minimax(self, pos_gato, pos_raton, profundidad, es_maximizador):
        ...
        if es_maximizador: # Turno simulado del RATÓN 
            max_eval = float('-inf')
